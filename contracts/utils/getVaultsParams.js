...
exports.getNonScheduleParams = exports.getScheduleParams = exports.getTonAirdropParams = exports.getTosAirdropParams = exports.getLpRewardParams = exports.getInitialLiquidityParams = exports.getPublicSaleParams = void 0;
var ethers_1 = require("ethers");
var getPublicSaleParams = function (tier, percents, saleAmount, price, hardcapAmount, changeTOSPercent, times, claimCounts, claimTimes, claimPercents) {
    ...
    for (var i = 0; i < claimCounts; i++) {
        InitalParameterPublicSaleClaim.claimTimes.push(ethers_1.ethers.BigNumber.from("" + claimTimes[i]));
        InitalParameterPublicSaleClaim.claimPercents.push(ethers_1.ethers.BigNumber.from("" + claimPercents[i]));
    }
    return {
...
exports.getPublicSaleParams = getPublicSaleParams;
var getInitialLiquidityParams = function (totalAmount, tosPrice, tokenPrice, price, startTime, fee) {
    return {
...
exports.getInitialLiquidityParams = getInitialLiquidityParams;
var getLpRewardParams = function (claimer, token0, token1, fee, totalAmount, totalClaimCount, firstClaimAmount, firstClaimTime, secondClaimTime, roundIntervalTime) {
    return {
        poolParams: {
            token0: token0,
            token1: token1,
...
exports.getLpRewardParams = getLpRewardParams;
var getTosAirdropParams = function (claimer, totalAmount, totalClaimCount, firstClaimAmount, firstClaimTime, secondClaimTime, roundIntervalTime) {
    return {
        claimer: claimer,
        totalAllocatedAmount: ethers_1.ethers.BigNumber.from("" + totalAmount),
        totalClaimCount: ethers_1.ethers.BigNumber.from("" + totalClaimCount),
...
exports.getTosAirdropParams = getTosAirdropParams;
var getTonAirdropParams = function (claimer, totalAmount, totalClaimCount, firstClaimAmount, firstClaimTime, secondClaimTime, roundIntervalTime) {
    return {
        claimer: claimer,
        totalAllocatedAmount: ethers_1.ethers.BigNumber.from("" + totalAmount),
        totalClaimCount: ethers_1.ethers.BigNumber.from("" + totalClaimCount),
...
exports.getTonAirdropParams = getTonAirdropParams;
var getScheduleParams = function (name, claimer, totalAmount, totalClaimCount, firstClaimAmount, firstClaimTime, secondClaimTime, roundIntervalTime) {
    return {
        vaultName: name,
        params: {
            claimer: claimer,
...
exports.getScheduleParams = getScheduleParams;
...
exports.getNonScheduleParams = getNonScheduleParams;
